...
${OBJECTDIR}/TinyXmlLib/GameController.o: TinyXmlLib/GameController.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TinyXmlLib/GameController.o TinyXmlLib/GameController.cpp

${OBJECTDIR}/TinyXmlLib/LogicGameController.o: TinyXmlLib/LogicGameController.cpp 
	${MKDIR} -p ${OBJECTDIR}/TinyXmlLib
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TinyXmlLib/LogicGameController.o TinyXmlLib/LogicGameController.cpp

${OBJECTDIR}/TinyXmlLib/ViewGameController.o: TinyXmlLib/ViewGameController.cpp 
	${MKDIR} -p ${OBJECTDIR}/TinyXmlLib
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TinyXmlLib/ViewGameController.o TinyXmlLib/ViewGameController.cpp
