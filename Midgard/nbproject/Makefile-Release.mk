...
${OBJECTDIR}/Armas.o: Armas.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Armas.o Armas.cpp

${OBJECTDIR}/Barbara.o: Barbara.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Barbara.o Barbara.cpp
...
${OBJECTDIR}/CienciaTecnologia.o: CienciaTecnologia.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CienciaTecnologia.o CienciaTecnologia.cpp

${OBJECTDIR}/Combate.o: Combate.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Combate.o Combate.cpp
...
${OBJECTDIR}/Edda.o: Edda.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Edda.o Edda.cpp
...
${OBJECTDIR}/FeSupersticion.o: FeSupersticion.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FeSupersticion.o FeSupersticion.cpp
...
${OBJECTDIR}/readSerial.o: readSerial.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/readSerial.o readSerial.cpp
