...
${OBJECTDIR}/Datos/jsonReader.o: Datos/jsonReader.cpp 
	${MKDIR} -p ${OBJECTDIR}/Datos
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Datos/jsonReader.o Datos/jsonReader.cpp

${OBJECTDIR}/Datos/jsonWriter.o: Datos/jsonWriter.cpp 
	${MKDIR} -p ${OBJECTDIR}/Datos
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Datos/jsonWriter.o Datos/jsonWriter.cpp
